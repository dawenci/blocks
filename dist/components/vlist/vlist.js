...
export let BlVList = (() => {
    ...
    let _fixedItemSize_decorators;
    let _fixedItemSize_initializers = [];
    ...
    let _$listSize_decorators;
    let _$listSize_initializers = [];
    let _$list_decorators;
    let _$list_initializers = [];
    let _$busy_decorators;
    let _$busy_initializers = [];
    var BlVList = class extends BlComponent {
        static {
            ...
            _fixedItemSize_decorators = [attr('boolean')];
            ...
            _$viewport_decorators = [shadowRef('#viewport')];
            _$listSize_decorators = [shadowRef('#list-size')];
            _$list_decorators = [shadowRef('#list')];
            _$busy_decorators = [shadowRef('#loading')];
            ...
            __esDecorate(this, null, _fixedItemSize_decorators, { kind: "accessor", name: "fixedItemSize", static: false, private: false, access: { has: obj => "fixedItemSize" in obj, get: obj => obj.fixedItemSize, set: (obj, value) => { obj.fixedItemSize = value; } } }, _fixedItemSize_initializers, _instanceExtraInitializers);
            ...
            __esDecorate(this, null, _$listSize_decorators, { kind: "accessor", name: "$listSize", static: false, private: false, access: { has: obj => "$listSize" in obj, get: obj => obj.$listSize, set: (obj, value) => { obj.$listSize = value; } } }, _$listSize_initializers, _instanceExtraInitializers);
            ...
            __esDecorate(this, null, _$busy_decorators, { kind: "accessor", name: "$busy", static: false, private: false, access: { has: obj => "$busy" in obj, get: obj => obj.$busy, set: (obj, value) => { obj.$busy = value; } } }, _$busy_initializers, _instanceExtraInitializers);
            __esDecorate(null, _classDescriptor = { value: this }, _classDecorators, { kind: "class", name: this.name }, null, _classExtraInitializers);
            BlVList = _classThis = _classDescriptor.value;
        ...
        #fixedItemSize_accessor_storage = __runInitializers(this, _fixedItemSize_initializers, void 0);
        get fixedItemSize() { return this.#fixedItemSize_accessor_storage; }
        set fixedItemSize(value) { this.#fixedItemSize_accessor_storage = value; }
        ...
        #$listSize_accessor_storage = __runInitializers(this, _$listSize_initializers, void 0);
        get $listSize() { return this.#$listSize_accessor_storage; }
        set $listSize(value) { this.#$listSize_accessor_storage = value; }
        ...
        #$busy_accessor_storage = __runInitializers(this, _$busy_initializers, void 0);
        get $busy() { return this.#$busy_accessor_storage; }
        set $busy(value) { this.#$busy_accessor_storage = value; }
        constructor() {
            super();
        ...
        setData(value, options = {}) {
            ...
            this.bindData(data, Object.assign({
