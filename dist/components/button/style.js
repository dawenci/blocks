import { __color_primary, __color_primary_light, __color_primary_dark, __color_danger, __color_danger_light, __color_danger_dark, __color_success, __color_success_light, __color_success_dark, __color_warning, __color_warning_light, __color_warning_dark, __color_primary_shadow, __color_danger_shadow, __color_success_shadow, __color_warning_shadow, __color_primary_disabled, __color_danger_disabled, __color_success_disabled, __color_warning_disabled, } from '../../theme/var-light.js';
export const style = `
/* <component>button */
/* 变量 */
:host([type="primary"]) {
