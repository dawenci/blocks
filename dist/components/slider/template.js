...
import { __color_primary, __border_color_base, __transition_duration, } from '../../theme/var-light.js';
let templateCache;
export function template() {
  ...
  #point.active {
    ...
    outline: 0 none;
    box-shadow: 0 0 2px 2px ${useColorWithOpacity(__color_primary, 0.5)};
  }
