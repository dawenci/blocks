...
import { __bg_base, __fg_base, __radius_base, __z_index_popup_base, __z_index_popup_focus, } from '../../theme/var-light.js';
export const popupStyleTemplate = makeStyleTemplate(`
:host {
...
`);
export const popupTemplate = makeFragmentTemplate(`
<i id="arrow"></i>
<slot></slot>
`);
