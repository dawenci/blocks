import { __border_color_base, __border_color_disabled, __color_primary, __color_primary_dark, __color_primary_light, __fg_base, __fg_disabled, __height_base, __height_large, __height_small, __radius_base, __transition_duration, } from '../../theme/var-light.js';
let templateCache;
export function template() {
    if (templateCache)
        return templateCache;
    const comTemplate = document.createElement('template');
    comTemplate.innerHTML = `<style>
  :host {
