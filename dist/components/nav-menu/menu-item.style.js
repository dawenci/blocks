import { __fg_base, __fg_hover, __fg_active, __fg_disabled, __fg_placeholder, __font_family, __height_base, __height_large, __transition_duration, __height_small, __color_primary, __bg_hover, __bg_active, } from '../../theme/var-light.js';
export const style = `
:host {
  display: block;
  position: relative;
