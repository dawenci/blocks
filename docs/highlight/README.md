...
![minified](https://img.shields.io/github/size/highlightjs/cdn-release/build/highlight.pack.js?label=minified)
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/10.5.0/highlight.pack.js"></script>
...
<script src="https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@10.5.0/build/highlight.pack.js"></script>
<!-- and it's easy to individually load additional languages -->
...
<script src="https://unpkg.com/@highlightjs/cdn-assets@10.5.0/highlight.pack.js"></script>
<!-- and it's easy to individually load additional languages -->
<script src="https://unpkg.com/@highlightjs/cdn-assets@10.5.0/languages/go.min.js"></script>
```

**Note:** *The CDN-hosted `highlight.pack.js` package doesn't bundle every language.* It would be
...
You can also download and self-host the same assets we serve up via our own CDNs.  We publish those builds to the [cdn-release](https://github.com/highlightjs/cdn-release) GitHub repository.  You can easily pull individual files off the CDN endpoints with `curl`, etc; if say you only needed `highlight.pack.js` and a single CSS file.
